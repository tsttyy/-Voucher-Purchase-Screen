...
class VoucherService {
  ...
  PaymentMethod get selectedPaymentMethod => _state.selectedPaymentMethod;
  double get discountPercent => _state.discountPercent;
  double get youPay => _state.youPay;
  double get savings => _state.savings;
  bool get isValidAmount => _state.isValidAmount;
  bool get isPurchaseDisabled => _state.isPurchaseDisabled;
  Voucher? get voucher => _state.voucher;
